 ...
 * Uses Firestore batch writes for improved performance
 * @param conversationId - The conversation ID
...
export async function sendMessage(
  ...
  // Batch operation 1: Add message
  batch.set(messageRef, messageData);

  // Batch operation 2: Update conversation's lastMessage and updatedAt
  ...
  // Commit both operations atomically (single network round trip)
  await batch.commit();
